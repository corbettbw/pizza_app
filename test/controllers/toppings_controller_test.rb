...
class ToppingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create topping" do
    assert_difference("Topping.count") do
      post toppings_url, params: { topping: { description: @topping.description, name: @topping.name } }
    end
  ...
  test "should update topping" do
    patch topping_url(@topping), params: { topping: { description: @topping.description, name: @topping.name } }
