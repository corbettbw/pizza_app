...
class PizzasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pizza" do
    assert_difference("Pizza.count") do
      post pizzas_url, params: { pizza: { description: @pizza.description, name: @pizza.name } }
    end
  ...
  test "should update pizza" do
    patch pizza_url(@pizza), params: { pizza: { description: @pizza.description, name: @pizza.name } }
